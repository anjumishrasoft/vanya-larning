...
export const LANGUAGES = {
  en: {
    title: 'DentaVision Pro',
    dashboard: 'Dashboard',
    diagnostics: 'AI Symptom Checker',
    consultation: 'Teleconsult',
    ...
    status: 'Oral Health Index',
    coins: 'DentaCoins Earned'
  },
  hi: {
    title: 'डेंटाविज़न प्रो',
    dashboard: 'डैशबोर्ड',
    diagnostics: 'AI लक्षण जाँच',
    consultation: 'टेली-परामर्श',
    tracker: 'आदत ट्रैकर',
    carePlan: 'उपचार योजना',
    appointments: 'अपॉइंटमेंट',
    records: 'मेडिकल रिकॉर्ड',
    billing: 'बिलिंग और क्लेम',
    doctors: 'डॉक्टर खोजें',
    analytics: 'स्वास्थ्य विश्लेषण',
    education: 'रोगी शिक्षा',
    welcome: 'स्वागत है, जॉन डो!',
    status: 'मौखिक स्वास्थ्य सूचकांक',
    coins: 'डेंटाकॉइन्स अर्जित'
  },
  mr: {
    title: 'डेंटाव्हिजन प्रो',
    dashboard: 'डॅशबोर्ड',
    diagnostics: 'AI लक्षण तपासणी',
    consultation: 'टेली-सल्ला',
    tracker: 'सवय ट्रॅकर',
    carePlan: 'उपचार योजना',
    appointments: 'अपॉइंटमेंट',
    records: 'वैद्यकीय रेकॉर्ड',
    billing: 'बिलिंग आणि क्लेम',
    doctors: 'डॉक्टर शोधा',
    analytics: 'आरोग्य विश्लेषण',
    education: 'रुग्ण शिक्षण',
    welcome: 'स्वागत आहे, जॉन डो!',
    status: 'तोंडी आरोग्य निर्देशांक',
    coins: 'डेंटाकॉइन्स कमावले'
  }
};
